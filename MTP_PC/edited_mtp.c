...
//Thread 1
//Function for input and buffer 1 in thread 1
...
//Thread 2
//Function for taking from buffer 1, filling buffer 2 and line sperating function
char get_buffer_1(){
      pthread_mutex_lock(&mutex_1);
      while(count_1 == 0)
...
//Thread 3
//Taking from buffer 2, putting to buffer 3, and 
char get_buffer_2(){
      pthread_mutex_lock(&mutex_2);
      while(count_2 == 0)
